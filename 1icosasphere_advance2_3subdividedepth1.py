...
def insertsubnodes(vertices,mat1):
    for i, v in enumerate(vertices):
        ...
        bpy.context.object.name = "nodesub"+str(i+1).zfill(2); 
...
def subdivide(v1,v2,v3):
    ...
    return [(v12[0],v12[1],v12[2]),(v23[0],v23[1],v23[2]),(v31[0],v31[1],v31[2])];
...
mat_yellow = makeMaterial('Yellow', (1,1,0), (1,1,1), 1);
...
#insertplane("plane01",matsemi_red,vertices[0:4]);
#insertplane("plane02",matsemi_green,vertices[4:8]);
#insertplane("plane03",matsemi_blue,vertices[8:12]);
...
for i,indice in enumerate(indices):
    subverts = subdivide( vertices[indice[0]], vertices[indice[1]], 
    vertices[indice[2]] );
    
    insertsubnodes(subverts,mat_yellow);
